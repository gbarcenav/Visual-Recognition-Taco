...
var visualRecognition = new VisualRecognitionV3({
  version: "2019-05-29",
  iam_apikey: "IWexYzqCM2X5RCjO5chEFR-u3B5sYP9svoGaSeGzkXD5"
});
  ...
  upload(req, res, err => {
    if (err) {
      ...
      if (req.file == undefined) {
        ...
        var classifier_ids = ["Tacos_1101416385"];
        ...
        visualRecognition.classify(params, function(err, response) {
          if (err) console.log(err);
            ...
            x = response;
            var whatClass = JSON.stringify(
              x.images[0].classifiers[0].classes[0].class,
              null,
              2
            );
            var score = JSON.stringify(
              x.images[0].classifiers[0].classes[0].score,
              null,
              2
            );
            var type_hierarchy = JSON.stringify(
              x.images[0].classifiers[0].classes[0].type_hierarchy,
              null,
              2
            );
